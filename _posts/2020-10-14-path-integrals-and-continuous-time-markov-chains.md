...
As we let the observation rate $$\lambda$$ tend to infinity, we get better approximations of the continuous-time Markov chain and the limits of integrals should also behave well. This strategy also works well for path integrals in relativistic quantum theory, e.g. see §5 of [[GZ02]](#ref-GZ02).
