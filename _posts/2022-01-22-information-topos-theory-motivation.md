...
If we have a bundle $$\pi:\Delta \rightarrow \Gamma$$ and some topology $$C$$ of open sets over the base space $$\Gamma,$$ we may construct a presheaf $$U: C^\text{op}\rightarrow \text{Set}$$ from $$\pi$$ by associating to each open set the set of sections over that open set. See the tutorial [[B20a]](#ref-B20a) by John Baez for an excellent description of this construction.
