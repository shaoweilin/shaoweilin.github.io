...
Classical textbooks for information theory define the relative information in terms of entropy (and cross entropy). We could choose instead to think of the relative information as the fundamental object, and entropy as a special case [[G11]](#ref-G11), [[C17]](#ref-C17).
...
When $$Q$$ is not absolutely continuous with respect to $$P,$$ the Radon-Nikodym derivative $$dQ/dP$$ does not exist and the above definition of $$I_{Q\Vert P}$$ does not make sense. To extend the definition, we consider the relative information of a partition of $$\Omega$$ [[G11]](#ref-G11).
